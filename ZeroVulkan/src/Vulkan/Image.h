...
namespace ZeroVulkan
{
    ...
    inline void createImage(VkImage& img, VkDeviceMemory& imgDevMem, uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties) {
